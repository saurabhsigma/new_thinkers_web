  ...
  return (
    <div className={styles.container}>
      <header className={styles.header}>
        <button onClick={handleMenuClick} className={styles.menuButton}>☰</button>
        <h1 className={styles.headerTitle}>Student Dashboard</h1>
        <Link href="/login"><button  className={styles.logoutButton}>Login</button></Link>
        <Link href="/content_view"><button  className={styles.logoutButton} >Content</button></Link>
